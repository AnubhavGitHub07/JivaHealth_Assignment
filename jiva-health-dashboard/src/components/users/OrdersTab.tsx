            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <select
                  ...
                  className="h-9 pl-3 pr-8 rounded-lg border border-slate-200 bg-white text-sm text-slate-700 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-500"
